...
public class GoToRealmePhonePage implements Task {

    private String phoneWebsite;


    public GoToRealmePhonePage(String phoneWebsite) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                Scroll.to(MovistarEquiposRenovarPage.BTN_REALME_BRAND),
                JavaScriptClick.on(MovistarEquiposRenovarPage.BTN_REALME_BRAND),
    ...
    public static GoToRealmePhonePage onThePage(String phoneWebsite) {
        return Tasks.instrumented(GoToRealmePhonePage.class, phoneWebsite);
    }
}
