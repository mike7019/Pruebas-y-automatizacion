...
public class MovistarEquiposRenovarPage extends PageObject {
    ...
    public static final Target TXT_NORMAL_PRICE =Target.the("normal price").locatedBy("//section[@class='c-content-phone active']//p[@class='t-left c-phone__price color-darkBlue']//span");
}
