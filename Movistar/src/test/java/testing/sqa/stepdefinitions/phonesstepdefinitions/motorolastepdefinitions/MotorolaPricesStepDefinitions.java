package testing.sqa.stepdefinitions.phonesstepdefinitions.motorolastepdefinitions;
...
public class MotorolaPricesStepDefinitions {
    ...
    @When("^Brandon clicks on (.*) validates the correct site, selects Motorola and clicks Online Purchase botton$")
    public void brandonClicksOnPhoneWebSiteValidatesTheCorrectSiteSelectsMotorolaAndClicksOnlinePurchaseBotton(String phoneWebsite) {

        OnStage.theActorInTheSpotlight().attemptsTo(
                GoToMotorolaPhonePage.onThePage(phoneWebsite)
        );
    ...
    public void brandonVisualizeTheMotorolaPriceOnTheEShopMatchesWithPriceCheckedOnThePrice() {
