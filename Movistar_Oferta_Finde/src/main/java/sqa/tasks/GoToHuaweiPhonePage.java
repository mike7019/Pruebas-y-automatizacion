...
public class GoToHuaweiPhonePage implements Task {

    private String phoneWebsite;


    public GoToHuaweiPhonePage(String phoneWebsite) {
    ...
    public static GoToHuaweiPhonePage onThePage(String phoneWebsite) {
        return Tasks.instrumented(GoToHuaweiPhonePage.class, phoneWebsite);
    }
}
