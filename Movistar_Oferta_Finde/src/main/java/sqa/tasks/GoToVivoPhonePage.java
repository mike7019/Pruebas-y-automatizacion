...
public class GoToVivoPhonePage implements Task {

    private String phoneWebsite;


    public GoToVivoPhonePage(String phoneWebsite) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                Scroll.to(MovistarEquiposRenovarPage.BTN_VIVO_BRAND),
                JavaScriptClick.on(MovistarEquiposRenovarPage.BTN_VIVO_BRAND),
    ...
    public static GoToVivoPhonePage onThePage(String phoneWebsite) {
        return Tasks.instrumented(GoToVivoPhonePage.class, phoneWebsite);
    }
}
