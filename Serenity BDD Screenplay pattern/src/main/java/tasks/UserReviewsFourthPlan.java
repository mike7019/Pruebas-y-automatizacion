...
public class UserReviewsFourthPlan implements Task {

private int plan;

    public UserReviewsFourthPlan(int plan) {
        this.plan = plan;
    }

    //This is the way to call the task
    public static UserReviewsFourthPlan onThePage(int plan) {
        return Tasks.instrumented(UserReviewsFourthPlan.class, plan);
    }
