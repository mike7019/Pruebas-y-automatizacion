...
public class UserReviewsThirdPlan implements Task {

    private int plan;

    public UserReviewsThirdPlan(int plan) {
        this.plan = plan;
    }

    public static UserReviewsThirdPlan onThePage(int plan) {
        return Tasks.instrumented(UserReviewsThirdPlan.class, plan);
    }
